...
export const cleaning = <i className="fa-solid fa-broom"></i>;
export const methods = <i className="fa-solid fa-palette"></i>;
export const waste = <i className="fa-solid fa-recycle"></i>;
